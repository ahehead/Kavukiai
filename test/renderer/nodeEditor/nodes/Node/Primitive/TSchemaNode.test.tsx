...
import { TSchemaNode } from 'renderer/nodeEditor/nodes/Node/Primitive/TSchemaNode';
...
test('TSchemaNode.data() returns object schema built from properties', () => {
  const node = new TSchemaNode(history, area, dataflow);
