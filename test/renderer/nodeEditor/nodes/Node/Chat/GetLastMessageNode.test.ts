...
import { GetLastMessageNode } from 'renderer/nodeEditor/nodes/Node/Chat/GetLastMessageNode'
...
test('GetLastMessageNode with role', () => {
  const result = node.data({ list: [messages], isAddRole: [true], roleString: ['Assistant'] })
