...
export const LLMPredictionFragmentReasoningType = Type.Union(
  ...
  { description: "Type of reasoning for a prediction fragment." }
);
...
export const LLMPredictionFragment = Type.Object(
  {
    content: Type.String({ description: "String content of the fragment." }),
    tokensCount: Type.Number({
      description: "Number of tokens contained in this fragment.",
    }),
  ...
  { description: "Represents a fragment of a prediction from an LLM." }
);
 ...
 * @public
 */
export const ChatAppendOpts = Type.Object(
  {
    images: Type.Optional(Type.Array(Type.Any({ description: "FileHandle" }))),
  },
  { description: "Options to use with Chat#append." }
);
export type ChatAppendOpts = Static<typeof ChatAppendOpts>;
