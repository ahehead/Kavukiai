...
import { IpcChannel, type LMStudioLoadRequestArgs, type LMStudioPortEvent } from 'shared/ApiType'
...
async function handleLoadModel(evt: IpcMainEvent, data: unknown): Promise<void> {
